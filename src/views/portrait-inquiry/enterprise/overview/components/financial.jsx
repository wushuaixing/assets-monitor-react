...
import { getFinancial } from '@/utils/api/portrait-inquiry/enterprise/overview';
				...
				{timeLineDataNum > 0 || RingDataNum > 0 ? (
					<div>
						...
						<div className="overview-container-content">
							...
							{RingDataNum > 0 && <RingEcharts title={`${selectType === 'publicity' ? '项目类型分布' : '项目状态分布'}`} Data={RingData} id="financeEcharts" customColorArray={['#1C80E1', '#45A1FF', '#59C874', '#FCD44A', '#FB8E3C', '#F2657A', '#965EE3', '#4561FF']} />}
