...
class Mortgage extends React.Component {
	...
	getData = (value) => {
		...
		mortgageSearch(params).then((res) => {
			if (res && res.data) {
				// 获取当前高度，动态移动滚动条
	...
	search = () => {
		...
		navigate(generateUrlWithParams('/search/detail/mortgage', fields));
		this.setState({
			page: 1,
			current: 1,
			params: fields,
	...
	queryReset = () => {
		...
		navigate('/search/detail/mortgage');
		this.setState({
			params: {},
			dataList: [],
			totals: 0,
	...
	render() {
		...
		return (
			<div className="yc-content-query">
				...
				{/* 分隔下划线 */}
				<div className="yc-noTab-hr" style={{ clear: 'both' }} />
