			...
			<div className="assets-info-content yc-space-nowrap">
				<li>
					...
					<span className="list list-content" style={{ color: '#186fc7' }}>
						<Ellipsis content={rowContent.projectName ? rowContent.projectName : rowContent.url} url={rowContent.url} tooltip width={200} isSourceLink  customColor={rowContent.url ? '' : '#20242e'} />
					</span>
				</li>
				<li>
