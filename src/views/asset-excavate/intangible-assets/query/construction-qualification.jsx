	...
	render() {
		...
		return (
			<div className="yc-content-query">
				...
				<div className="yc-query-item">
					<Input title="证书编号" style={_style1} size="large" maxLength="25" placeholder="资质证书编号" {...getFieldProps('certificateNumber')} />
				</div>
				<div className="yc-query-item">
					<Input title="资质名称" style={_style1} size="large" maxLength="40" placeholder="资质名称" {...getFieldProps('qualificationName')} />
				</div>
				<div className="yc-query-item">
					...
					<DatePicker
						...
						style={_style2}
						placeholder="开始日期"
						{...getFieldProps('issueTimeStart', timeOption)}
						disabledDate={time => timeRule.disabledStartDate(time, getFieldValue('issueTimeEnd'))}
					/>
					...
					<DatePicker
						...
						style={_style2}
						placeholder="结束日期"
						{...getFieldProps('issueTimeEnd', timeOption)}
						disabledDate={time => timeRule.disabledEndDate(time, getFieldValue('issueTimeStart'))}
					/>
				</div>
				<div className="yc-query-item">
